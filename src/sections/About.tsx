...
const About = () => {
    ...
    const stats = [
        { label: t('about.stats.experience'), value: "5+ Years", icon: Globe },
        { label: t('about.stats.companies'), value: "4", icon: Code2 },
        { label: t('about.stats.stack'), value: "Full", icon: Cpu },
    ];

    return (
        <section ref={containerRef} id="about" className="py-32 relative bg-dark overflow-hidden">
            {/* Ambient Background */}
                ...
                >
                    <div className="relative group perspective-1000">
                        ...
                        <div className="relative aspect-[3/5] rounded-2xl overflow-hidden bg-white/5 border border-white/10 ring-1 ring-white/5">
                            <img
                                src="/sebastian.jpg"
                                alt="Sebastián Díaz — Software Developer"
                ...
                <div>
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 mb-6">
                            ...
                            <span className="text-xs font-mono text-brand-300 tracking-widest uppercase">{t('about.role')}</span>
                        </div>
                        ...
                        <div className="space-y-6 text-lg text-white/60 leading-relaxed font-light">
                            <p className="border-l-2 border-brand-500/30 pl-6">
                                <Trans i18nKey="about.description1">
                                    Full Stack Developer specialized in transforming complex business visions into <span className="text-white font-medium">scalable, high-impact digital realities</span>.
                                </Trans>
                            </p>
                            <p>
                                <Trans i18nKey="about.description2">
                                    With a proven track record architecting platforms like <span className="text-brand-400">Reactable AI</span> and <span className="text-brand-400">Junngla SpA</span>, I bridge the gap between <span className="text-white/80">enterprise-grade engineering</span>—spanning Node.js, Nest.js, and Cloud Infrastructure—and premium product design.
                                </Trans>
                            </p>
                            <p>
                                <Trans i18nKey="about.description3">
                                    A Certified Scrum Professional dedicated to <span className="text-white/80">agile precision</span> and <span className="text-white/80">evolutionary code quality</span>. I don't just build software; I engineer adaptive systems designed to scale with your business and captivate your users.
                                </Trans>
                            </p>
                        </div>
